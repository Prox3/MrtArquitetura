...
function emailSub_sendEmails(){
	...
	foreach($emails as $email){
		...
		//send mail
		mail($to,$subject[$post_id],$user_body,$headers);
	}
...
add_action('auto-draft_to_publish', 'emailSub_publishPost');
add_action('draft_to_publish', 'emailSub_publishPost');
...
class EmailSubscriptionWidget extends WP_Widget {
  private $defaults = array(
                          ...
                          'fail_msg' => 'Some unexpeded error occurred',
